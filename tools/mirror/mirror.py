...
class MirrorCtrl(object):
    ...
    @staticmethod
    def rename(name, orig='L_', replace='R_'):
        new_name = name.replace(orig, replace)[:-1]
    ...
    def __init__(self, obj, orig, replace, x_axis_checkbox, y_axis_checkbox, z_axis_checkbox):
        self.obj = obj
        self.orig = orig
    ...
    def mirror(self):
        ...
        print self.x_axis_checkbox
        print self.y_axis_checkbox
        print self.z_axis_checkbox
