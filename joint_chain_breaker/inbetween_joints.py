...
class Add_Inbetween_UI(object):
    ...
    def add_between_jnt_ui(cls):
        ...
        slider_layout = cmds.rowColumnLayout("slider_layout", adjustableColumn=True, numberOfColumns=1 ,columnAttach=(2, 'both', 2), columnWidth=[(1,400)], parent="Main_column", columnSpacing=[(1, 10)], rowSpacing=[(1, 10)])
        ...
        button_layout = cmds.rowColumnLayout("button_layout", numberOfColumns=2,  columnAttach=(2, 'both', 2),  columnWidth=[(1, 200), (2, 200)], parent="Main_column", columnSpacing=[(1, 10), (2, 10)])
